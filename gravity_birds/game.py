...
class GravityBirdsGame:
    def __init__(self) -> None:
        ...
        self.font_large = pygame.font.SysFont("Avenir Next", 66, bold=True)
        self.font_title = pygame.font.SysFont("Avenir Next", 40, bold=True)
        self.font_body = pygame.font.SysFont("Avenir Next", 28)
    ...
    def create_level(self, index: int) -> None:
        ...
        floor = pymunk.Segment(self.space.static_body, (-200, 930), (WIDTH + 200, 930), 16)
        floor.friction = 1.0
    ...
    def draw_game(self) -> None:
        ...
        pygame.draw.rect(self.screen, GROUND, (0, 930, WIDTH, 150))
        pygame.draw.rect(self.screen, (130, 97, 66), (0, 930, WIDTH, 22))
